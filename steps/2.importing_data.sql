...
-- Create view view1 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.CYBERSYN_DATA_CATALOG AS
SELECT * FROM CRIME_STATISTICS.CYBERSYN.CYBERSYN_DATA_CATALOG;

-- Create view view2 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.GEOGRAPHY_INDEX AS
SELECT * FROM CRIME_STATISTICS.CYBERSYN.GEOGRAPHY_INDEX;

-- Create view view3 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.GEOGRAPHY_RELATIONSHIPS AS
SELECT * FROM CRIME_STATISTICS.CYBERSYN.GEOGRAPHY_RELATIONSHIPS;

-- Create view view4 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.URBAN_CRIME_ATTRIBUTES AS
SELECT * FROM CRIME_STATISTICS.CYBERSYN.URBAN_CRIME_ATTRIBUTES;

-- Create view view5 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.URBAN_CRIME_INCIDENT_LOG AS
SELECT * FROM CRIME_STATISTICS.CYBERSYN.URBAN_CRIME_INCIDENT_LOG;

-- Create view view6 in A4_DB
CREATE OR REPLACE VIEW A4_DB.BIGDATA.URBAN_CRIME_TIMESERIES AS
